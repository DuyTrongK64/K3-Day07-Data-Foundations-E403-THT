...
class SentenceChunker:
    ...
    def chunk(self, text: str) -> list[str]:
        ...
        # Keep terminal punctuation with its sentence.  The expression covers
        # all boundaries required by the exercise while accepting repeated
        # whitespace and newlines commonly found in Markdown documents.
        sentences = [
            sentence.strip()
...
class RecursiveChunker:
    ...
    def _split(self, current_text: str, remaining_separators: list[str]) -> list[str]:
        ...
        # Reattach separators so punctuation/paragraph boundaries are not lost.
